 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = sagenes * 213,16 + arshins * 71,12 + vershoks * 4.445
 ...
 */
fun thirdDigit(number: Int): Int = (number / 100) % 1000
